  ...
  function newContext(e) {
    ...
    function o(e) {
      var t,
        i = e ? e.indexOf("!") : -1;
      return i > -1 &&
        ((t = e.substring(0, i)), (e = e.substring(i + 1, e.length))), [t, e];
    }
    function a(e, t, r, n) {
      var a,
        s,
        ...
        l = !0,
        h = "";
      return e || ((l = !1), (e = "_@r" + (T += 1))), (c = o(e)), (d =
        c[0]), (e = c[1]), d && ((d = i(d, p, n)), (s = getOwn(j, d))), e &&
        (d
          ? (h = r
              ? e
              : s && s.normalize
      ...
      if (!x) {
        if (
          ...
          return (e = makeError(
            ...
            null,
            a
          )), (e.contextName = q.contextName), c(e);
        d &&
          each(s, function(e) {
            f(e, {}, {});
          }), (o && !t) ||
    ...
    function g(e) {
      ...
      return m(t, q.onScriptLoad, "load", "onreadystatechange"), m(
        t,
        q.onScriptError,
        "error"
    ...
    return (E = {
      ...
      (this.events =
        getOwn(M, e.id) || {}), (this.map = e), (this.shim = getOwn(
        y.shim,
        e.id
      )), (this.depExports = []), (this.depMaps = []), (this.depMatched = []), (this.pluginMaps = {}), (this.depCount = 0);
    }), (b.prototype = {
              ...
              if (((this.defining = !0), this.depCount < 1 && !this.defined)) {
                if (isFunction(o)) {
                  ...
                  if (
                    ...
                    return (e.requireMap = this.map), (e.requireModules = this
                      .map.isDefine
                      ? [this.map.id]
              ...
              ? (
                  ...
                  u(
                    ...
                    bind(this, function(e) {
                      (this.map.normalizedMap = o), this.init(
                        [],
                        function() {
                          return e;
                        },
                ...
                : (
                    ...
                    (n.fromText = bind(this, function(i, r) {
                      var o = e.name,
                        ...
                        d = useInteractive;
                      r &&
                        (i = r), d && (useInteractive = !1), s(u), hasProp(y.config, t) && (y.config[o] = y.config[t]);
                      try {
                        req.exec(i);
                      } catch (e) {
                        return c(
                      ...
                      d &&
                        (useInteractive = !0), this.depMaps.push(u), q.completeLoad(o), m([o], n);
                    })),
      ...
      enable: function() {
        (k[
          this.map.id
        ] = this), (this.enabled = !0), (this.enabling = !0), each(
          this.depMaps,
          bind(this, function(e, t) {
            ...
            (i =
              e.id), (r = S[i]), hasProp(E, i) || !r || r.enabled || q.enable(e, this);
          })
        ), eachProp(
          this.pluginMaps,
          bind(this, function(e) {
        ...
        eachProp(e, function(e, t) {
          ...
          each(e.packages, function(e) {
            ...
            (t = (e = "string" == typeof e ? { name: e } : e)
              .name), e.location && (y.paths[t] = e.location), (y.pkgs[t] = e.name + "/" + (e.main || "main").replace(currDirRegExp, "").replace(jsSuffixRegExp, ""));
      ...
      makeRequire: function(t, n) {
        function o(i, r, u) {
          ...
          return n.enableBuildCallback &&
            ...
            : (
                v(),
                q.nextTick(function() {
                  v(), ((f = s(a(null, t))).skipMap =
                    n.skipMap), f.init(i, r, u, { enabled: !0 }), l();
                }),
                o
              );
        }
        return (n = n || {}), mixin(o, {
          ...
          (o.undef = function(e) {
            ...
            var i = a(e, t, !0),
              n = getOwn(S, e);
            (n.undefed = !0), r(e), delete j[e], delete P[i.url], delete M[
              e
      ...
      nameToUrl: function(e, t, i) {
        ...
        if (req.jsExtRegExp.test(e)) s = e + (t || "");
          ...
          (s = n.join("/")), (s =
            ("/" ===
              (s +=
                t || (/^data\:|^blob\:|\?/.test(s) || i ? "" : ".js")).charAt(
                0
              ) || s.match(/^[\w\+\.\-]+:/)
              ? ""
              : y.baseUrl) + s);
  ...
  if (void 0 === define) {
    ...
    void 0 === require ||
      ...
      return isArray(e) ||
        ...
        o.context &&
        (a = o.context), (n = getOwn(contexts, a)) ||
        (n = contexts[a] = req.s.newContext(a)), o && n.configure(o), n.require(
        e,
        t,
        i
      );
      ...
      (require = req), (req.version = version), (req.jsExtRegExp = /^\/|:|\?|\.js$/), (req.isBrowser = isBrowser), (s = req.s = {
      contexts: contexts,
      ...
      return (r.type = e.scriptType || "text/javascript"), (r.charset =
        "utf-8"), (r.async = !0), r;
      ...
      if (isBrowser)
        return (r = req.createNode(n, t, i)).setAttribute(
          "data-requirecontext",
          e.contextName
        ), r.setAttribute("data-requiremodule", t), !r.attachEvent ||
